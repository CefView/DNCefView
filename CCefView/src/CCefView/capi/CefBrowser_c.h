...
extern "C"
{
  ...
  CCEFVIEW_EXPORT void CCefBrowser_executeContextMenuCommand(ccefbrowser_class * thiz, int id);
  CCEFVIEW_EXPORT void CCefBrowser_cancelContextMenu(ccefbrowser_class * thiz);

...
extern "C"
{
  ...
  CCEFVIEW_EXPORT void CCefConfig_setCommandLinePassthroughDisabled(ccefconfig_class * thiz, bool disabled);
  ...
  CCEFVIEW_EXPORT const char * CCefConfig_builtinSchemaName(ccefconfig_class * thiz);

...
//////////////////////////////////////////////////////////////////////////
// cef struct
typedef cef_point_t CefViewPoint;

typedef cef_size_t CefViewSize;

typedef cef_rect_t CefViewRect;

typedef cef_screen_info_t CefViewScreenInfo;

typedef cef_range_t CefViewRange;

typedef cef_draggable_region_t CefViewDraggableRegion;

typedef cef_cursor_info_t CefViewCursorInfo;

typedef cef_composition_underline_t CefViewCompositionUnderline;

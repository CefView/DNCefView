...
public:
  ...
  void setCommandLinePassthroughDisabled(bool disabled);
  ...
  void setBuiltinSchemaName(const std::string& name);

  /// <summary>
  ///
  /// </summary>
  /// <returns></returns>
  const std::string& builtinSchemaName() const;
...
protected:
  ...
  /// </summary>
  /// <returns></returns>
  static const CCefConfig::ArgsMap& GetCommandLineArgs(const CCefConfig* config);

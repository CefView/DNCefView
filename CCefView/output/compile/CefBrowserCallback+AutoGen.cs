...
namespace DNCefView
{
    ...
    public partial struct CefBrowserCallback
    {
        ...
        // Source: bool pfnOnJSDialog(int, const void *, const char *, int, const char *, const char *, bool)
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate bool OnJSDialogCallback(int browserId, IntPtr dialogHandle, string originUrl, int dialogType, string messageText, string defaultPromptText, bool suppressMessage);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate bool OnBeforeNewPopupCreateCallback(string frameId, string targetUrl, string targetFrameName, CefViewWindowOpenDisposition targetDisposition, ref CefViewRect rect, IntPtr settings, [MarshalAs(UnmanagedType.Bool)] ref bool DisableJavascriptAccess);

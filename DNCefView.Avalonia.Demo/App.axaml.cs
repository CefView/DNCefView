    ...
    public partial class App : Application
    {
        ...
        public override void Initialize()
        {
            ...
            if (!Design.IsDesignMode)
            {
                ...
                string appLocalDataRoot = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
                string appLocalDataPath = Path.Combine(appLocalDataRoot, "DNCefView.Avalonia.Demo");
                string cefCachePath = Path.Combine(appLocalDataPath, "cefview.cache");

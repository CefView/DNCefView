...
public:
  ...
  /// </summary>
  static const std::string MainFrameID;

  /// <summary>
  ///
  /// </summary>
  static const std::string AllFrameID;
...
public:
  ...
  /// <returns>True on successful; otherwise false</returns>
  bool triggerEventOnFrame(const std::string& evtName, const std::string& evtArgs, const std::string& frameId);
  ...
  bool triggerEvent(const std::string& name,
                    ...
                    const std::string& frameId = CCefBrowser::MainFrameID);
  ...
  /// </param>
  /// <returns>True on successful; otherwise false</returns>
  bool executeJavascript(const std::string& frameId, const std::string& code, const std::string& url);
  ...
  /// <returns>True on successful; otherwise false</returns>
  bool executeJavascriptWithResult(const std::string& frameId,
...
private:
  ...
  /// <param name="args"></param>
  /// <returns></returns>
  bool sendEventNotifyMessage(const std::string& frameId, const std::string& name, const std::string& args);
